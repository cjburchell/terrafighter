...
public:
   ...
   BOOL              m_bFrameMoving;
   BOOL              m_bSingleStep;
   CComPtr<IDirect3D9>       m_pD3D;              // The main D3D object
...
protected:
   ...
   CComPtr<IDirect3DDevice9> m_pd3dDevice;        // The D3D rendering device
   ...
   CString           m_strFrameStats; // String to hold frame stats
...
public:
   ...
   virtual BOOL LookForMSG()                                  { return FALSE;}

   LPDIRECT3DDEVICE9 GetDevice(){return m_pd3dDevice;}

   D3DModeInfo*    GetModeInfo()
   {
      D3DAdapterInfo* pAdapterInfo = &m_Adapters[m_dwAdapter];
      D3DDeviceInfo*  pDeviceInfo  = &pAdapterInfo->devices[pAdapterInfo->dwCurrentDevice];
      return &pDeviceInfo->modes[pDeviceInfo->dwCurrentMode];
   }
